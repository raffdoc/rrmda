...
```{r plot1, fig.height=3, fig.width=9,fig.keep='high',include=TRUE, fig.cap="A histogram and density estimates for three outcomes."}
par(mfrow=c(1,3))
...
```{r plot2, fig.height=3, fig.width=5,fig.keep='high',include=TRUE, fig.cap="A boxplot of median moratlity accross the regeons."}
